...
function renderFormOptions() {
    ...
    newTodoSelect.innerHTML += `<option value="">Seleccione Categoria</option>`;
    editTodoSelect.innerHTML += `<option value="">Seleccione Categoria</option>`;
...
function renderTodos() {
    ...
    todosToRender.forEach(({ _id, categoryId, todo, date }) => {
